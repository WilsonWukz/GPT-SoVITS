...
# 打印调试信息
print("Loading inference_webui.py")

version = os.environ.get("version", "v2")
pretrained_sovits_name = [
    "D:/Software/GPT-SoVITS/v2/GPT-SoVITS-v2-240821/GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth",
    "D:/Software/GPT-SoVITS/v2/GPT-SoVITS-v2-240821/GPT_SoVITS/pretrained_models/s2G488k.pth"
]
pretrained_gpt_name = [
    "D:/Software/GPT-SoVITS/v2/GPT-SoVITS-v2-240821/GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt",
    "D:/Software/GPT-SoVITS/v2/GPT-SoVITS-v2-240821/GPT_SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt"
]
...
print(f"gpt_path before check: {gpt_path}")
print(f"sovits_path before check: {sovits_path}")

if isinstance(gpt_path, list) and gpt_path:
    gpt_path = gpt_path[0]
else:
    gpt_path = pretrained_gpt_name[0]

if isinstance(sovits_path, list) and sovits_path:
    sovits_path = sovits_path[0]
else:
    sovits_path = pretrained_sovits_name[0]

print(f"gpt_path after check: {gpt_path}")
print(f"sovits_path after check: {sovits_path}")

# 使用 Hugging Face 的 bert-base-chinese 模型
...
cnhubert_base_path = os.environ.get(
    "cnhubert_base_path", "D:/Software/GPT-SoVITS/v2/GPT-SoVITS-v2-240821/GPT_SoVITS/pretrained_models/chinese-hubert-base"
)
bert_path = os.environ.get(
    "bert_path", "D:/Software/GPT-SoVITS/v2/GPT-SoVITS-v2-240821/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large"
)
...
dict_language = {
    'en': 'english',
    'zh': 'chinese',  # Add this line if it doesn't exist
